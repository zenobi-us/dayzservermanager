...
function SectionCardsItem({
  ...
  return (
    <Card className={cn("@container/card", className)} onClick={onClick} {...props}>
      <CardHeader>
...
function SectionCardTextPrimary({ children, icon: Icon }: { children: ReactNode, icon: ElementType }) {
  return (
...
function SectionCardBadge({ label, icon }: { label: string, icon?: ReactNode }) {
  return (
