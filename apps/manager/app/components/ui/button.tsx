  ...
  compoundVariants: [
    {
      ...
      variant: 'ghost',
      className:
        'text-white dark:text-black hover:bg-accent/20 hover:text-white/80 dark:hover:bg-accent/20 dark:hover:text-black/80',
    },
  ],
});
...
function Button({
  ...
  return (
    <Comp
      data-slot="button"
      className={cn(buttonVariants({ variant, inverted, size, className }))}
      {...props}
    />
  );
}
