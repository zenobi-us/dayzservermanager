...
const badgeVariants = tv({
  base: [
    ...
    'border-current/80 bg-current/30',
  ...
  variants: {
    variant: {
      ...
      cautious:
        'border-transparent bg-cautious text-white [a&]:hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60',
      outline:
